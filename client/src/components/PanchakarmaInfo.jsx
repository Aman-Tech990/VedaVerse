...
const PanchaKarmaInfo = () => {
    return (
        <section className="relative w-full px-6 sm:px-12 lg:px-20 bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto space-y-4">
                ...
                <motion.p
                    ...
                    className="text-purple-950 font-semibold text-lg md:text-xl leading-relaxed text-justify"
                >
